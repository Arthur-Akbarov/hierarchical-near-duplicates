the collection of polygons the receiver maintains to describe its area\.
	the given rectangle (to|from) the collection of polygons the receiver maintains to describe its area\.
	...
	all of the polygons which make up the area covered by the argument (to|from) the collection of polygons the receiver maintains to describe its area\.
